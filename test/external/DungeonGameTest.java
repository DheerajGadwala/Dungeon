...
public class DungeonGameTest {
  ...
  public void setUp() {
    ...
    sample1 = new DungeonGame(10, 10, 0, false, 0);
    sample2 = new DungeonGame(6, 7, 0, false, 0);
  ...
  public void testMovePlayerException() {
    Game game = new DungeonGame(10, 10, 0, false, 0);
  ...
  public void testWrappingDungeon() {
    Game game = new DungeonGame(6, 7, 0, true, 0,
  ...
  public void testNonWrappingDungeon() {
    Game game = new DungeonGame(6, 7, 0, false, 0,
  ...
  public void testInterConnectivityNonZero() {
    Game s = new DungeonGame(5, 7, 60, true, 2,
  ...
  public void testInterconnectivityZero() {
    Game s = new DungeonGame(5, 7, 60, true, 0,
  ...
  public void testInvalidInterconnectivity() {
    new DungeonGame(6, 8, 0, true, 200);
  }
  ...
  public void testInvalidDungeonGameArguments1() {
    new DungeonGame(-5, 8, 0, true, 200);
  }
  ...
  public void testInvalidDungeonGameArguments3() {
    new DungeonGame(3, 3, 0, true, 200);
  }
  ...
  public void testPlayerLocationAtStart() {
    Game game = new DungeonGame(6, 10, 0, false, 0);
  ...
  public void testTreasurePercentage() {
    ...
    Assert.assertEquals(
        (int) (countCaves * game.getTreasurePercentage() / 100.0),
  ...
  public void testAddTreasureException1() {
    new DungeonGame(10, 10, -20, true, 3);
  }
  ...
  public void testAddTreasureException2() {
    new DungeonGame(10, 10, 120, true, 3);
  }
  ...
  private Game generateRandomDungeon() {
    ...
    return new DungeonGame(m, n, percentage, wrap, interconnectivity);
  }
