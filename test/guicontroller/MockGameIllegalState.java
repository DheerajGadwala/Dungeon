...
/**
 * This mock model throws illegal state exception when any of the
 * following six methods are called: move, moveToLocation, shoot, attack,
 * cedeTreasure, and cedeItem.
 */
class MockGameIllegalState implements GameWithObstacles {

  private final Appendable modelLog;
  private final String uniqueCode;

  MockGameIllegalState(Appendable modelLog, String uniqueCode) {
    if (modelLog == null) {
  ...
  public void attack() {
    try {
      ...
      throw new IllegalStateException("Because the model said so.");
